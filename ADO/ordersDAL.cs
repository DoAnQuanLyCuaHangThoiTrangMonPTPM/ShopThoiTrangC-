...
namespace ADO
{
    public class ordersDAL
    {
        ...
        public DataTable loadhoadon()
        {
            ...
            string sqlselect = "SELECT orders.`Id`, orders.`CustomerId`, orders.`EmployeeId`, orders.`Date`, orders.`Total`, employee.Name as 'TenNV', customer.Name as 'TenKH', customer.Phome  FROM `orders`, customer, employee WHERE orders.CustomerId = customer.Id and orders.EmployeeId = employee.Id";
